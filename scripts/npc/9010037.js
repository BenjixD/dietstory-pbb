...
/*Other*/ [[3993002, 10000], [3993000, 1000000], [2431174, 20000], [2434288, 400000], [4001832, 5000], [4310015, 100000], [4021031, 50000], [2502000, 8000], [2430692, 15000], [2023133, 50000], [2022749, 7000], [2022750, 7000], [2022751, 7000], [2022743, 7000], [2022744, 7000], [2022745, 7000], [2022794, 35000], [2022795, 35000], [2022796, 35000], [2022797, 35000], [2022798, 35000], [2022799, 35000], [3700080, 10000000], [3700096, 20000000], [3700049, 150000000], [5220000, 20000], [5220100, 400000], [3015617, 50000000], [3015517, 100000000], [3012026, 250000000], [3015349, 500000000], [3015642, 750000000], [2434530, 50000000], [2434574, 50000000], [2434289, 50000000], [2435832, 50000000], [2435433, 50000000]],
/*Dojo Dummies*/ [[2434330, 5000, "25% Reduced Ele (Straw)"], [2434329, 5000, "75% Reduced Ele (Straw)"], [2434328, 5000, "100% Reduced Ele (Straw)"], [2434327, 5000, "25% Reduced Ele (Oak)"], [2434326, 5000, "75% Reduced Ele (Oak)"], [2434325, 5000, "100% Reduced Ele (Oak)"], [2435744, 10000, "Enchanted Dummy"]],
...
function action(mode, type, selection) {
    ...
    else if (status == 1)
    {
        if (selection == 10) {
        ...
        else if (selection == 0 || selection == 1 || selection == 2 || selection == 4 || selection == 5 || selection == 6 || selection == 7 || selection == 8)
            {
            select = selection;
            ...
            var selStr = "Choose from any of the items below. \r\n";
            for (var i = 0; i < items[selection].length; i++) {
                selStr += "#b#L" + i + "##v" + items[selection][i][0] + "# Trade " + items[selection][i][2] + " for #r" + formatNumber(items[selection][i][1]) + "#b dojo points #l\r\n";
            }
            cm.sendSimple(selStr + "#k");
            status2 = 3;
        }
