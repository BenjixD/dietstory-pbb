...
function action(mode, type, selection) {
    ...
    else if (status == 1)
    {
        ...
        case 1:
                        ...
                        cm.dispose();
                        ...
                        else if (items[0][selection][0] == 1672027) {
                            if (cm.haveItem(1672020)) {
                            cm.getPlayer().setDPoints( cm.getPlayer().getDPoints() - items[0][selection][1]);
                            //cm.grab item scrolls/potential TODO-
                            cm.gainItem(1672020, -1);
                            //cm.place item scrolls/potential on upgraded heart. TODO-
                            cm.gainItem(1672027, 1);
                            cm.sendSimple("Thank you for the purchase");
                            } else {cm.sendSimple("You need a Lidium Heart in your inventory before I can upgrade it");}
                            cm.dispose();
                        }
                        else if (items[0][selection][0] == 1672040) {
                            if (cm.haveItem(1672027)) {
                            cm.getPlayer().setDPoints( cm.getPlayer().getDPoints() - items[0][selection][1]);
                            //cm.grab item scrolls/potential TODO-
                            cm.gainItem(1672027, -1);
                            //cm.place item scrolls/potential on upgraded heart. TODO-
                            ...
                            cm.sendSimple("Thank you for the purchase");
                            } else {cm.sendSimple("You need a Superior Lidium Heart in your inventory before I can upgrade it");}
                            cm.dispose();
                        }
                        else if (items[0][selection][0] == 1672069) {
                            if (cm.haveItem(1672040)) {
                            cm.getPlayer().setDPoints( cm.getPlayer().getDPoints() - items[0][selection][1]);
                            //cm.grab item scrolls/potential TODO-
                            cm.gainItem(1672040, -1);
                            //cm.place item scrolls/potential on upgraded heart. TODO-
                            ...
                            cm.sendSimple("Thank you for the purchase");
                            } else {cm.sendSimple("You need a Titanium Heart in your inventory before I can upgrade it");}
                            cm.dispose();
                        }
                        else {
                        cm.sendSimple("Thank you for the purchase");
