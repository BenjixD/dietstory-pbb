...
if (status == 0) { 
	...
	cm.sendAcceptDecline("By clicking accept here you agree to follow LucidMaple's TOS as stated in the forums."); //rule agreement
}
else if (status == 2) { 
    ...
    if (selection == 0) { // warrior
        ...
        if (cm.getLevel() >= 1) {
        	cm.sendSimple("The cool pirates! \r\n #L37# Buccaneer #l \r\n #L38# Corsair #l \r\n #L39# Thunder breaker #l \r\n #L40# Cannon master #l \r\n #L41# Jett #l \r\n #L42# Mechanic #l\r\n #L43# Angelic buster #l \r\n #L44# Shade #l");
        } 
    }else{ 
        cm.sendOk("I'm sorry, something went wrong, please contact an admin.");
        cm.dispose(); 
    }
	...
	if (selection == 5){ //hero
		...
		cm.gainExp(4589);
		cm.warp(100000000);	
	}	else if (selection == 25){ //beasttamer ! moet nog jobid!
		cm.changeJob(100);		
		cm.gainMeso(100000);
		...
		cm.gainExp(4589);
		cm.warp(100000000);	
	}	else if (selection == 40){ //cannoneer
		cm.changeJob(530);		
		cm.gainMeso(100000);
		...
		cm.gainExp(4589);
		cm.warp(100000000);	
	}	else if (selection == 44){ //shade !job id!
		cm.changeJob(100);		
		cm.gainMeso(100000);
		cm.gainItem(1482000,1);
