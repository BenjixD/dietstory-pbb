...
var mapz = Array(101,201,211,221,231,241,301,311,321,331,401,411,421,431,501,601);
...
function setup(eim, leaderid) {
	...
	for (var i = 0; i < mapz.length; i++) {
		...
		if (map != null) {
            ...
            if (map.getId() == 863010221) { // Lower Left Leg
            ...
            if (map.getId() == 863010231) { // Upper Left Leg
            ...
            if (map.getId() == 863010211) { // Upper Right Leg
            ...
            if (map.getId() == 863010201) { // Lower Right Leg
            ...
            if (map.getId() == 863010311) { // Upper Left Torso
            ...
            if (map.getId() == 863010301) { // Lower Left Torso
            ...
            if (map.getId() == 863010411) { // Upper Right Torso
            ...
            if (map.getId() == 863010401) { // Lower Right Torso
            ...
            if (map.getId() == 863010421) { // Upper Left Arm
            ...
            if (map.getId() == 863010321) { // Upper Right Arm
...
function playerEntry(eim, player) {
    var map = eim.getMapFactory().getMap(863010101);
...
function changedMap(eim, player, mapid) {
    if (mapid < 863010101 || mapid > 863010601) {
