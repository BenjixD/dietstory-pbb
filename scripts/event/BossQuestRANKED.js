...
function allMonstersDead(eim) {
    ...
    var num = Math.ceil(mobnum / 5) * 53714; // Will give total of 20,490,548 points  and  9,523,600 cash in total for 1 Ranked Dojo run
	...
	if (elapsedMinute == 0) {eim.broadcastPlayerMsg(5, "You have completed Ranked Dojo in " +elapsedSecond+ " seconds");}
	else {eim.broadcastPlayerMsg(5, "You have completed Ranked Dojo in " +elapsedMinute+ " minutes and " +elapsedSecond+ " seconds");}
    }
