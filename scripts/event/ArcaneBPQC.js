...
function allMonstersDead(eim) {
    ...
    var num = mobnum * 547284; // Will give total of 39,021,130 points  and  14,993,870 cash in total for 1 ArcaneBPQ Chaos run
	...
	if (elapsedMinute == 0) {eim.broadcastPlayerMsg(5, "You have completed Arcane BossPQ Chaos in " +elapsedSecond+ " seconds");}
	else {eim.broadcastPlayerMsg(5, "You have completed Arcane BossPQ Chaos in " +elapsedMinute+ " minutes and " +elapsedSecond+ " seconds");}
    }
